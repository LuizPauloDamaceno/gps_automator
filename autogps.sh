...
cp *.18O /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/last_day/rinex_obs; #Copia Arquivo de observação
cp *.18N /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/last_day/rinex_nav_gps; #Copia Arquivo de Navegação 
cp *.18G /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/last_day/rinex_nav_glo; #Copia Arquivo GPS
cp *.18L /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/last_day/rinex_nav_gal; #Copia Arquivo GALILEO

cp *.18O /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/rinex_obs; #Copia arquivo de Observação
cp *.18N /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/rinex_nav_gps; #Copia arquivo de Navegação
cp *.18G /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/rinex_nav_glo; #Copia arquivo GPS
cp *.18L /home/clock/Arquivos_RINEX/GZ_ParaCGGTTS/rinex_nav_gal; #Copia arquivo GALILEO
...
sleep 0.25
MJD=$(echo $(($(date "+%s")/86400+40587))); #fórmula geral para calculo do Dia Juliano Modificado com tempo em segundos do linux
sleep 0.25
MJDP=$(($MJD-1)); #Acrescentar -1 se necessário (subtrair um)
sleep 0.25
