...
wput ftp://put_your_address_here *.* >> /home/clock/automatizador_gps/autolog.txt
...
cd /home/clock/automatizador_gps/ClockData/
...
#Nova forma de formar o clockdata:
(printf "%s" $MJD; printf "%s" " 10016 1353028 "; printf "%09s\n"  $daydiff) > $FILENAME

echo "Aquisição da diferença entre Relógio local e escala UTC do dia (em nS): " >> /home/clock/automatizador_gps/autolog.txt

cat $FILENAME >> /home/clock/automatizador_gps/autolog.txt;

echo " ------------------------------------------------------------------------" >> /home/clock/automatizador_gps/autolog.txt

wput ftp://put_your_address_here $FILENAME >> /home/clock/automatizador_gps/autolog.txt

echo " ------------------------------------------------------------------------" >> /home/clock/automatizador_gps/autolog.txt

# Realiza a execução do script mensal
cd /home/clock/automatizador_gps/CDM/
./fornine.sh >> /home/clock/automatizador_gps/autolog.txt
